...
import com.java.manager.Manager_ModifyStock;

//import sun.applet.Main;

public class Member_SellCheck extends JFrame{
	public JLabel pname_lb;
	public JTextField P_SizeField;
	public JTextField P_ColorField;
	public JLabel pnum_lb;
	public JLabel pnum_lb2;
	public JLabel P_Img;
	...
	public Member_SellCheck(String id) {
	...
	public void AddP_Panel(JPanel panel, String id) {
		...
		panel.setLayout(null);
		pnum_lb = new JLabel("현재수량 : ");
		pnum_lb.setBounds(245, 280, 120, 25);
		pnum_lb.setFont(f1);
		panel.add(pnum_lb);
		...
		panel.setLayout(null);
		pnum_lb2 = new JLabel("30");
		pnum_lb2.setBounds(320, 280, 80, 25);
		pnum_lb2.setFont(f1);
		panel.add(pnum_lb2);
	...
	//---------------------------------------버튼---------------------------------------
		...
		//수정하기 버튼
		sellbtn = new JButton("판매하기");
		sellbtn.setBounds(380, 310, 110, 40);
		sellbtn.setFont(f4);
		panel.add(sellbtn);
		...
		sellbtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String p_type = class_lb.getText();
				...
				new Member_SellStock(p_name, p_price, id);
				dispose();
