...
public class Member_TableCell2 extends AbstractCellEditor implements TableCellEditor, TableCellRenderer {
	
	JButton jb;
	
	public Member_TableCell2(Member_Home MH) {
		...
		jb.addActionListener(e -> {
			...
			String photo = null;
			Member_ReadProduct read = new Member_ReadProduct();
