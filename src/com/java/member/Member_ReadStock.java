...
public class Member_ReadStock extends JFrame{
	...
	public void AddP_Panel(JPanel panel) {
		...
		panel.setLayout(null);
		pnum_lb2 = new JLabel();
		pnum_lb2.setBounds(285, 280, 80, 25);
		pnum_lb2.setFont(f1);
		panel.add(pnum_lb2);
	...
	//---------------------------------------버튼---------------------------------------
		...
		updatebtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				new Manager_ModifyStock(p_id, p_name, p_price, P_image, p_num, p_size, p_color, p_type);
				dispose();
